...
COS_API_KEY_ID = "et9Bf8QPO_iiGgcEJT1rPaYJLrdgXHzGvIiv0ZETb0qw"
COS_INSTANCE_CRN = "crn:v1:bluemix:public:iam-identity::a/7e5c3a98bf7643bda6b31f2ab6536b1d::serviceid:ServiceId-6c9f9eb5-98a6-45ce-b0eb-06fdd463c0ab"
...
@app.route('/')
def index():
    files = get_bucket_contents('assignment3images')
