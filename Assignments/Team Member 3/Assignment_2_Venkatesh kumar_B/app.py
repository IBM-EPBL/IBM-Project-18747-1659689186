...
try:
    ...
    conn = ibm_db.connect("DATABASE=bludb;HOSTNAME=ea286ace-86c7-4d5b-8580-3fbfa46b1c66.bs2io90l08kqb1od8lcg.databases.appdomain.cloud;PORT=1505;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=czl12632;PWD=OOTT9m912CFnxdAE",'','')
