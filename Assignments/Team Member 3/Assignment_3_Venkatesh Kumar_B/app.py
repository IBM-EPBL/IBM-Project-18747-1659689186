...
COS_API_KEY_ID = "Z2DwJYVvxKFe1NLJd83iRDqtHFCbqPv07PWRxclNRIpH"
COS_INSTANCE_CRN = "crn:v1:bluemix:public:iam-identity::a/4cdeebbd575f4527b74e3371512efaf1::serviceid:ServiceId-2f5ad70f-ff9a-4a4b-b98e-ff49fbbb2217"
...
@app.route('/')
def index():
    files = get_bucket_contents('assignment3pics')
