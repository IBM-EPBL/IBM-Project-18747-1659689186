...
COS_API_KEY_ID = "zEUT82FKGNzMwaFKCCkDrFU3G_awgxBoazMy76uboblA"
COS_INSTANCE_CRN = "crn:v1:bluemix:public:iam-identity::a/59bd30938bfb450a8c82c98e12d28195::serviceid:ServiceId-597c2879-dc73-4484-ba6c-2830dc88714b"
...
@app.route('/')
def index():
    files = get_bucket_contents('demopictures')
